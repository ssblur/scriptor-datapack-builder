...
<div class="text-sm w-full border-l-1 border-gray-300">
    ...
    {#each spell.spells as partial, index}
        <div class="pl-2 odd:bg-gray-100 even:bg-white w-full">
